...
v4 = IntVar()
v5 = IntVar()
chkbox = Checkbutton(window, text="Read",variable=v3)
chkbox2 = Checkbutton(window, text="Sleep",variable=v4)
chkbox3 = Checkbutton(window, text="Eat",variable=v5)

chkbox.place(x=80, y=300)
chkbox2.place(x=130, y=300)
chkbox3.place(x=200, y=300)

lbl3 = Label(window, text="Hobby")
